...
} from "@/app/students/api/create-student";
...
export function CreateStudentDialog({
  ...
  const [formData, setFormData] = React.useState<CreateStudentInput>({
    email: "",
    password: "",
    fullName: "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(`Student "${input.fullName}" created successfully!`);
    } catch (error) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new student account with role automatically set to student.
          </DialogDescription>
        </DialogHeader>
